package com.yjfshop123.live.ui.videolist.target;
...
public abstract class ProgressTarget<T, Z> extends WrappingTarget<Z> implements
     ...
     * {@link com.bumptech.xchat.load.model.GlideUrl GlideUrl} loads this needs to return
     * {@link com.bumptech.xchat.load.model.GlideUrl#toStringUrl toStringUrl}. For custom models
     * do the same as your
     * {@link com.bumptech.xchat.load.model.stream.BaseGlideUrlLoader BaseGlideUrlLoader} does.
     *
