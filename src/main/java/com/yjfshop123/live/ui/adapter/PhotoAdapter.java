...
public class PhotoAdapter extends BaseAdapter {
    ...
    private ArrayList<AlbumVideoResponse.AlbumBean> lists;
    private String flag;
    ...
    public PhotoAdapter(Context context, ArrayList<AlbumVideoResponse.AlbumBean> lists, String flag) {
        this.context = context;
        this.lists = lists;
        this.flag = flag;
    }
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        Uri img = Uri.parse(lists.get(i).getFull_url());
