...
public class WithdrawDetailActivity extends BaseActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_title_center.setText(R.string.withdraw_detail);

        tvStateText.setText(getString(R.string.jb_hint_3));
    ...
    private void getWithdrawList(){
        ...
        OKHttpUtils.getInstance().getRequest("app/user/getWithdrawList", body, new RequestCallback() {
            @Override
