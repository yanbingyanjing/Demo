...
public class ExpenditureDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_title_center.setText(R.string.expenditure_detail);

        tvStateText.setText(getString(R.string.jb_hint_2));
    ...
    private void getPayoutList(){
        ...
        OKHttpUtils.getInstance().getRequest("app/user/getPayoutList", body, new RequestCallback() {
            @Override
