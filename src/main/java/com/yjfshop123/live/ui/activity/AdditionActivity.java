...
import com.yjfshop123.live.ui.fragment.AdditonFragment;
...
public class AdditionActivity  extends BaseActivityForNewUi {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setCenterTitleText(getString(R.string.addition_egg));
...
//        mViewPager.setOffscreenPageLimit(2);
    ...
    private class MyFragmentPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            AdditonFragment fragment1 = (AdditonFragment) mContentFragments.get(position);
            return fragment1;
        }
