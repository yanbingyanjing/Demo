...
public class H_1_1_Fragment extends BaseFragment implements OnBannerListener {
...
//                .setBannerTitles(App.titles)//标题
    ...
    private void vicinityUser(){
        ...
        OKHttpUtils.getInstance().getRequest("app/index/vicinityUser", body, new RequestCallback() {
            @Override
