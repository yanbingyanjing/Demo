...
//                .setBannerTitles(App.titles)//标题
    ...
    private void followUser(){
        ...
        OKHttpUtils.getInstance().getRequest("app/index/followUser", body, new RequestCallback() {
            @Override
