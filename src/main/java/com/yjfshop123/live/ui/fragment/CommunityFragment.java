...
import com.yjfshop123.live.ui.widget.SelectThreeBtnView;
...
public class CommunityFragment extends BaseFragment implements ViewPager.OnPageChangeListener, View.OnClickListener, GongYueDialog.GongYueInterface {
    ...
    protected void initAction() {
        ...
        String[] titles = getResources().getStringArray(R.array.comm_titles);
...
//        mViewPager.setOffscreenPageLimit(2);
    ...
    protected void initEvent() {
        ...
        community_qiangliao.setOnClickListener(this);
        community_qiuliao.setOnClickListener(this);
        ...
        community_xchat_tv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                switch (mPosition) {
                    case POS_0:
    ...
    private class MyFragmentPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                ...
                case POS_1:
                    if (mContent == null) {
                        mContent = new VideoRecyclerViewFragment_2();
                        mContentFragments.put(POS_1, mContent);
                    }
                    VideoRecyclerViewFragment_2 fragment2 = (VideoRecyclerViewFragment_2) mContentFragments.get(POS_1);
                    return fragment2;
                case POS_2:
                    if (mContent == null) {
                        mContent = new VideoRecyclerViewFragment_3();
                        mContentFragments.put(POS_2, mContent);
                    }
                    VideoRecyclerViewFragment_3 fragment3 = (VideoRecyclerViewFragment_3) mContentFragments.get(POS_2);
                    return fragment3;
            }
            return null;
        }
