package com.yjfshop123.live.ui.widget.float_view;
...
public class FloatWindowManager {
    //应用内悬浮窗，只能在父view中移动和缩放,缩放不存在兼容性问题
    public static final int FW_TYPE_ROOT_VIEW = 10;
    //WM实现，无需权限，targetSDK必须小于25，不能在桌面显示
    public static final int FW_TYPE_APP_DIALOG = 11;
    //window Manager实现，需权限，退出应用，可在桌面显示，缩放存在兼容性问题
