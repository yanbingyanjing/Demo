...
public class CountDownView extends View {
    ...
    public CountDownView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int as=(int)SystemUtils.sp2px(context, 20);
        mRingProgessTextSize = a.getDimensionPixelSize(R.styleable.CountDownView_progressTextSize, as);
    ...
    public void setCountdownTime(int mCountdownTime,float mCurrentProgress) {
