...
public class WetituoFragment extends BaseFragment {
    @BindView(R.id.list)
    ...
    protected void initAction() {
        ...
        xunZhangAdapter = new WeituoAdapter(mContext);
        xunZhangAdapter.setListener(new WeituoAdapter.OnItemClickListener() {
