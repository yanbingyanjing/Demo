...
public class PhotoViewAttacher implements IPhotoView, OnTouchListener, OnGestureListener, ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private com.yjfshop123.live.server.utils.photo.GestureDetector mScaleDragDetector;
