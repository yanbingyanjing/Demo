...
public class ImageLoader {
    ...
    public synchronized void init(ImageLoaderConfiguration configuration) {
        if (configuration == null) {
            ...
            if (this.configuration == null) {
                NLog.d("Initialize ImageLoader with configuration", new Object[0]);
                this.engine = new ImageLoaderEngine(configuration);
                this.configuration = configuration;
            } else {
                NLog.w("Try to initialize ImageLoader which had already been initialized before. To re-init ImageLoader with new configuration call ImageLoader.destroy() at first.", new Object[0]);
            }
        ...
        if (imageAware == null) {
            ...
            if (TextUtils.isEmpty(uri)) {
                ...
                if (bmp != null && !bmp.isRecycled()) {
                    NLog.d("Load image from memory cache [%s]", new Object[]{memoryCacheKey});
    ...
    public void destroy() {
        if (this.configuration != null) {
            NLog.d("Destroy ImageLoader", new Object[0]);
        }
