...
public class OtcGoldFragment extends BaseFragment {
...
//
        ...
        mViewPager.setCurrentItem(0);
        order_manager.setText(R.string.kuaijiedingdan);
        order_manager.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), OrderManagerActivity.class);
