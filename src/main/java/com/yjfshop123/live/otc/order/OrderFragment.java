...
import com.yjfshop123.live.otc.ui.OrderConfirActivity;
...
public class OrderFragment extends BaseFragment {
    ...
    OtcOrderManagerFragment otcOrderManagerFragment;
    public void setActivity(OrderManagerActivity orderManagerActivity) {
        this.orderManagerActivity = orderManagerActivity;
    }
    public void setFragment(OtcOrderManagerFragment otcOrderManagerFragment) {
        this.otcOrderManagerFragment = otcOrderManagerFragment;
    }
    @Override
        ...
        xunZhangAdapter.setListener(new OrderAdapter.OnItemClickListener() {
            ...
            public void onclick(OtcOrderListResponse.OtcOrderData data) {
                ...
                if (data.order_type == 0) {
                    ...
                    //卖单详情
                    Intent intent = new Intent(getActivity(), OrderSellDetailActivity.class);
                    intent.putExtra("order", data.order);
                    startActivity(intent);
    ...
    public void getData(final boolean isFromRefresh) {
        ...
        OKHttpUtils.getInstance().getRequest("app/trade/otcOrderList", body, new RequestCallback() {
            @Override
    ...
    public void loadData(String result) {
        ...
        if (data.list.size() > 0) {
            ...
            if (otcOrderManagerFragment != null) {
                otcOrderManagerFragment.setHongDian(View.VISIBLE);
            }
            ...
            if (otcOrderManagerFragment != null) {
                otcOrderManagerFragment.setHongDian(View.INVISIBLE);
            }
