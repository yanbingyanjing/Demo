...
public class ShopDetailActivity extends BaseAppCompatActivity {
    ...
    ZLoadingDialog dialog = new ZLoadingDialog(ShopDetailActivity.this);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (getIntent() != null) {
            if (!TextUtils.isEmpty(getIntent().getStringExtra("data"))) {
                data = new Gson().fromJson(getIntent().getStringExtra("data"), ShopList.ShopData.class);
