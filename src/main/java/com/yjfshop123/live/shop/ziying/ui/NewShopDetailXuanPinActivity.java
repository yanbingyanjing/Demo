...
public class NewShopDetailXuanPinActivity extends BaseAppCompatActivity {
    ...
    ZLoadingDialog dialog = new ZLoadingDialog(NewShopDetailXuanPinActivity.this);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (getIntent() != null) {
            goldPrice = getIntent().getStringExtra("price");
            if (!TextUtils.isEmpty(getIntent().getStringExtra("xuanpin_data"))) {
                xuanpin = new Gson().fromJson(getIntent().getStringExtra("xuanpin_data"), XuanPInResopnse.ItemData.class);
                goods_id = xuanpin.goods_id;
    ...
    private XuanPInResopnse.ItemData xuanpin;
    ...
    public void getData(boolean form) {
        ...
        HttpUtil.getInstance().getAsynHttpNoSign(1, new HttpUtil.HttpCallBack() {
            ...
            public void onResponse(int what, String response) {
                LoadDialog.dismiss(NewShopDetailXuanPinActivity.this);
            ...
            public void onFailure(int what, String error) {
                LoadDialog.dismiss(NewShopDetailXuanPinActivity.this);
                NToast.shortToast(NewShopDetailXuanPinActivity.this, error);
                //  if (!form) dialog.dismiss();
            }
    ...
    private void onBuy() {
        ...
        fragment.setData(xuanpin, goldPrice);
