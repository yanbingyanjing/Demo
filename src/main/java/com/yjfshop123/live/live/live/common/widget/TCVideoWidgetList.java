...
public class TCVideoWidgetList {
    ...
    public TCVideoWidgetList(Activity context, final TCVideoWidget.OnRoomViewListener l) {
        ...
        ImageView coverImgs[] = {null, null, null};
        coverImgs[0] = (ImageView)context.findViewById(R.id.cover_imageview1);
        coverImgs[1] = (ImageView)context.findViewById(R.id.cover_imageview2);
        coverImgs[2] = (ImageView)context.findViewById(R.id.cover_imageview3);

        // 连麦拉流
        mVideoViews.add(new TCVideoWidget(videoViews[0], kickoutBtns[0], loadingBkgs[0], loadingImgs[0], l, coverImgs[0]));
        mVideoViews.add(new TCVideoWidget(videoViews[1], kickoutBtns[1], loadingBkgs[1], loadingImgs[1], l, coverImgs[1]));
        mVideoViews.add(new TCVideoWidget(videoViews[2], kickoutBtns[2], loadingBkgs[2], loadingImgs[2], l, coverImgs[2]));
