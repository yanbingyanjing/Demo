...
public class LiveGiftAnimPresenter {
    ...
    private void showGifGift(LiveReceiveGiftBean bean) {
        ...
        NLog.e("gif礼物----->" + bean.getLiveReceiveGiftBeanItem().getGiftName() + "----->" + url);
    ...
    private void playHaoHuaGift(File file) {
        if (mTempGifGiftBean.getLiveReceiveGiftBeanItem().getStyle() == 2) {//豪华礼物类型 2:gif动图 3:svga动图
