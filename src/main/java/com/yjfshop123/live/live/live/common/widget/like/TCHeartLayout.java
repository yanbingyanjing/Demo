 ...
 */
package com.yjfshop123.live.live.live.common.widget.like;
...
public class TCHeartLayout extends RelativeLayout {
    ...
    private static int[] drawableIds = new int[]{
            R.mipmap.icon_live_light_1,
            R.mipmap.icon_live_light_2,
            R.mipmap.icon_live_light_3,
            R.mipmap.icon_live_light_4,
            R.mipmap.icon_live_light_5,
            R.mipmap.icon_live_light_6};
