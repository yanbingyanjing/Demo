package com.yjfshop123.live.live.live.common.widget.gift.adapter;
...
import com.yjfshop123.live.live.live.common.widget.gift.view.GiftMarkView;
import com.yjfshop123.live.live.live.common.widget.gift.view.MyRadioButton;
...
//                ImgLoader.display(bean.getIcon(), mIcon);
                ...
                mPrice.setText(bean.getCoin() + mCoinName);
                if (bean.getCh_cat_id() == 0) {//普通 礼物
                    // 礼物样式 1:图片 2:gif动图 3:svga动图
