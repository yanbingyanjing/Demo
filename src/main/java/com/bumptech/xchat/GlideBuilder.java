...
import com.bumptech.xchat.load.engine.bitmap_recycle.BitmapPoolAdapter;
import com.bumptech.xchat.load.engine.bitmap_recycle.LruBitmapPool;
import com.bumptech.xchat.load.engine.cache.DiskCache;
import com.bumptech.xchat.load.engine.cache.InternalCacheDiskCacheFactory;
import com.bumptech.xchat.load.engine.cache.LruResourceCache;
import com.bumptech.xchat.load.engine.cache.MemoryCache;
import com.bumptech.xchat.load.engine.cache.MemorySizeCalculator;
import com.bumptech.xchat.load.engine.executor.FifoPriorityThreadPoolExecutor;
...
public class GlideBuilder {
     ...
     * {@link com.bumptech.xchat.load.engine.Resource}s that are not currently in use.
     *
     ...
     * {@link com.bumptech.xchat.load.engine.Resource} data and thumbnails.
     *
     ...
     * {@link com.bumptech.xchat.load.engine.Resource} data on disk.
     *
     ...
     * {@link com.bumptech.xchat.load.engine.Resource}s that are not already in the cache.
     *
     * <p>
    ...
    /**
     * Sets the {@link ExecutorService} implementation to use when retrieving
     * {@link com.bumptech.xchat.load.engine.Resource}s that are currently in cache.
     *
     * <p>
     *     Any implementation must order requests based on their {@link Priority} for thumbnail
     *     requests to work properly.
