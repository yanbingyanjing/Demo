...
import com.bumptech.xchat.util.ByteArrayPool;
import com.bumptech.xchat.util.ExceptionCatchingInputStream;
import com.bumptech.xchat.util.MarkEnforcingInputStream;
...
public abstract class Downsampler implements BitmapDecoder<InputStream> {
    ...
    public static final Downsampler AT_LEAST = new Downsampler() {
        ...
        @Override
        public String getId() {
            return "AT_LEAST.com.bumptech.xchat.load.data.bitmap";
        }
    };
    ...
    public static final Downsampler AT_MOST = new Downsampler() {
        ...
        @Override
        public String getId() {
            return "AT_MOST.com.bumptech.xchat.load.data.bitmap";
        }
    };
    ...
    public static final Downsampler NONE = new Downsampler() {
        ...
        @Override
        public String getId() {
            return "NONE.com.bumptech.xchat.load.data.bitmap";
        }
    };
