package com.bumptech.xchat.load.model;
 ...
 * @param <Y> The type of the data that can be used by a {@link com.bumptech.xchat.load.ResourceDecoder} to decode a
 *           resource.
 */
public interface ModelLoader<T, Y> {
     ...
     *              {@link com.bumptech.xchat.request.target.Target#SIZE_ORIGINAL} to indicate that the resource should
