package com.bumptech.xchat.load.engine.prefill;

import android.graphics.Bitmap;

/**
 * A container for a set of options used to pre-fill a {@link com.bumptech.xchat.load.engine.bitmap_recycle.BitmapPool}
