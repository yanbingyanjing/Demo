...
import com.bumptech.xchat.load.resource.gif.GifDrawableTransformation;
...
public class GifRequestBuilder<ModelType>
    ...
    /**
     * Transforms each frame of the GIF using {@link com.bumptech.xchat.load.resource.bitmap.CenterCrop}.
     *
     * @see #fitCenter()
    ...
    /**
     * Transforms each frame of the GIF using {@link com.bumptech.xchat.load.resource.bitmap.FitCenter}.
     *
     * @see #centerCrop()
     * @see #transformFrame(BitmapTransformation...)
     * @see #transformFrame(Transformation[])
