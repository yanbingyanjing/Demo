...
import com.bumptech.xchat.load.resource.bitmap.BitmapTransformation;
import com.bumptech.xchat.load.resource.bitmap.Downsampler;
import com.bumptech.xchat.load.resource.bitmap.FileDescriptorBitmapDecoder;
import com.bumptech.xchat.load.resource.bitmap.ImageVideoBitmapDecoder;
import com.bumptech.xchat.load.resource.bitmap.StreamBitmapDecoder;
import com.bumptech.xchat.load.resource.bitmap.VideoBitmapDecoder;
...
public class BitmapRequestBuilder<ModelType, TranscodeType>
    ...
    /**
     * Transform images using {@link com.bumptech.xchat.load.resource.bitmap.CenterCrop}.
     *
     * @see #fitCenter()
    ...
    /**
     * Transform images using {@link com.bumptech.xchat.load.resource.bitmap.FitCenter}.
     *
     * @see #centerCrop()
     * @see #transform(BitmapTransformation...)
     * @see #transform(Transformation[])
