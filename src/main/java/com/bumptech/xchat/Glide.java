...
import com.bumptech.xchat.load.engine.Engine;
import com.bumptech.xchat.load.engine.bitmap_recycle.BitmapPool;
import com.bumptech.xchat.load.engine.cache.DiskLruCacheFactory;
import com.bumptech.xchat.load.engine.cache.MemoryCache;
import com.bumptech.xchat.load.engine.prefill.BitmapPreFiller;
import com.bumptech.xchat.load.engine.prefill.PreFillType;
...
import com.bumptech.xchat.load.model.file_descriptor.FileDescriptorFileLoader;
import com.bumptech.xchat.load.model.file_descriptor.FileDescriptorResourceLoader;
import com.bumptech.xchat.load.model.file_descriptor.FileDescriptorStringLoader;
import com.bumptech.xchat.load.model.file_descriptor.FileDescriptorUriLoader;
import com.bumptech.xchat.load.model.stream.HttpUrlGlideUrlLoader;
import com.bumptech.xchat.load.model.stream.StreamByteArrayLoader;
import com.bumptech.xchat.load.model.stream.StreamFileLoader;
import com.bumptech.xchat.load.model.stream.StreamResourceLoader;
import com.bumptech.xchat.load.model.stream.StreamStringLoader;
import com.bumptech.xchat.load.model.stream.StreamUriLoader;
import com.bumptech.xchat.load.model.stream.StreamUrlLoader;
import com.bumptech.xchat.load.resource.bitmap.CenterCrop;
import com.bumptech.xchat.load.resource.bitmap.FileDescriptorBitmapDataLoadProvider;
import com.bumptech.xchat.load.resource.bitmap.FitCenter;
import com.bumptech.xchat.load.resource.bitmap.GlideBitmapDrawable;
import com.bumptech.xchat.load.resource.bitmap.ImageVideoDataLoadProvider;
import com.bumptech.xchat.load.resource.bitmap.StreamBitmapDataLoadProvider;
import com.bumptech.xchat.load.resource.drawable.GlideDrawable;
import com.bumptech.xchat.load.resource.file.StreamFileDataLoadProvider;
import com.bumptech.xchat.load.resource.gif.GifDrawable;
import com.bumptech.xchat.load.resource.gif.GifDrawableLoadProvider;
import com.bumptech.xchat.load.resource.gifbitmap.GifBitmapWrapper;
import com.bumptech.xchat.load.resource.gifbitmap.GifBitmapWrapperTransformation;
import com.bumptech.xchat.load.resource.gifbitmap.ImageVideoGifDrawableLoadProvider;
import com.bumptech.xchat.load.resource.transcode.GifBitmapWrapperDrawableTranscoder;
import com.bumptech.xchat.load.resource.transcode.GlideBitmapDrawableTranscoder;
import com.bumptech.xchat.load.resource.transcode.ResourceTranscoder;
import com.bumptech.xchat.load.resource.transcode.TranscoderRegistry;
import com.bumptech.xchat.manager.RequestManagerRetriever;
import com.bumptech.xchat.module.GlideModule;
import com.bumptech.xchat.module.ManifestParser;
import com.bumptech.xchat.provider.DataLoadProvider;
import com.bumptech.xchat.provider.DataLoadProviderRegistry;
import com.bumptech.xchat.request.FutureTarget;
import com.bumptech.xchat.request.Request;
import com.bumptech.xchat.request.animation.GlideAnimation;
import com.bumptech.xchat.request.target.ImageViewTargetFactory;
import com.bumptech.xchat.request.target.Target;
import com.bumptech.xchat.request.target.ViewTarget;
 ...
 * maintaining an {@link Engine}, {@link BitmapPool}, {@link com.bumptech.xchat.load.engine.cache.DiskCache} and
 * {@link MemoryCache}.
 */
public class Glide {
     ...
     *     {@link com.bumptech.xchat.load.ResourceDecoder}s and {@link com.bumptech.xchat.load.Transformation}s. Use
     ...
     * models. Typically the {@link RequestManager#using(com.bumptech.xchat.load.model.stream.StreamModelLoader)} or
     * {@link RequestManager#using(com.bumptech.xchat.load.model.file_descriptor.FileDescriptorModelLoader)} syntax is
     ...
     * </p>
     *
     * @see RequestManager#using(com.bumptech.xchat.load.model.file_descriptor.FileDescriptorModelLoader)
     * @see RequestManager#using(com.bumptech.xchat.load.model.stream.StreamModelLoader)
     *
