...
import com.bumptech.xchat.load.model.file_descriptor.FileDescriptorModelLoader;
import com.bumptech.xchat.load.model.stream.MediaStoreStreamLoader;
import com.bumptech.xchat.load.model.stream.StreamByteArrayLoader;
import com.bumptech.xchat.load.model.stream.StreamModelLoader;
import com.bumptech.xchat.manager.ConnectivityMonitor;
import com.bumptech.xchat.manager.ConnectivityMonitorFactory;
import com.bumptech.xchat.manager.Lifecycle;
import com.bumptech.xchat.manager.LifecycleListener;
import com.bumptech.xchat.manager.RequestManagerTreeNode;
import com.bumptech.xchat.manager.RequestTracker;
import com.bumptech.xchat.signature.ApplicationVersionSignature;
import com.bumptech.xchat.signature.MediaStoreSignature;
import com.bumptech.xchat.signature.StringSignature;
...
public class RequestManager implements LifecycleListener {
     ...
     *     so be wary of using
     *     {@link GenericRequestBuilder#listener(com.bumptech.xchat.request.RequestListener)}} when
     ...
     * @see #load(Object)
     *
     * @param string A file path, or a uri or url handled by {@link com.bumptech.xchat.load.model.UriLoader}.
     */
     ...
     * {@link com.bumptech.xchat.load.model.UriLoader}.
     */
     ...
     *
     * <p>
     *  Falls back to the registered {@link com.bumptech.xchat.load.model.ModelLoaderFactory} registered for
    ...
    /**
     * Returns a request builder that uses the {@link com.bumptech.xchat.load.model.ModelLoaderFactory} currently
     * registered for {@link File} to load the image represented by the given {@link File}. Defaults to
     * {@link com.bumptech.xchat.load.model.stream.StreamFileLoader.Factory} and
     * {@link com.bumptech.xchat.load.model.stream.StreamFileLoader} to load images from {@link File}s.
     *
     *  <p>
     ...
     * to {@link com.bumptech.xchat.load.model.stream.StreamResourceLoader.Factory} and
     * {@link com.bumptech.xchat.load.model.stream.StreamResourceLoader} to load resource id models.
     *
     * <p>
     ...
     * {@link com.bumptech.xchat.load.model.stream.HttpUrlGlideUrlLoader} and
     * {@link com.bumptech.xchat.load.data.HttpUrlFetcher} to load {@link URL} models.
     *
     * @see #from(Class)
     * @see #load(URL)
     *
    ...
    /**
     * Returns a request builder that uses the {@link com.bumptech.xchat.load.model.ModelLoaderFactory}s currently
     ...
     * {@link com.bumptech.xchat.load.model.ModelLoaderFactory}s registered for the given model class for
     ...
     *     {@link DrawableRequestBuilder#into(com.bumptech.xchat.request.target.Target)}. You may
     ...
     *     {@link DrawableRequestBuilder#into(com.bumptech.xchat.request.target.Target)}}. However,
     ...
     * {@link com.bumptech.xchat.load.data.DataFetcher} to convert the model to.
     */
