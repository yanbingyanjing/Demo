...
import com.bumptech.xchat.load.MultiTransformation;
...
import com.bumptech.xchat.load.resource.UnitTransformation;
...
import com.bumptech.xchat.provider.ChildLoadProvider;
import com.bumptech.xchat.provider.LoadProvider;
import com.bumptech.xchat.request.FutureTarget;
import com.bumptech.xchat.request.GenericRequest;
import com.bumptech.xchat.request.Request;
import com.bumptech.xchat.request.RequestCoordinator;
import com.bumptech.xchat.request.RequestFutureTarget;
import com.bumptech.xchat.request.RequestListener;
import com.bumptech.xchat.request.ThumbnailRequestCoordinator;
import com.bumptech.xchat.request.animation.GlideAnimationFactory;
import com.bumptech.xchat.request.animation.NoAnimation;
import com.bumptech.xchat.request.animation.ViewAnimationFactory;
import com.bumptech.xchat.request.animation.ViewPropertyAnimation;
import com.bumptech.xchat.request.animation.ViewPropertyAnimationFactory;
import com.bumptech.xchat.request.target.PreloadTarget;
import com.bumptech.xchat.request.target.Target;
import com.bumptech.xchat.signature.EmptySignature;
 ...
 * @param <DataType> The data type that the resource {@link com.bumptech.xchat.load.model.ModelLoader} will provide that
...
public class GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> implements Cloneable {
     ...
     *     {@link com.bumptech.xchat.load.model.ModelLoader}, {@link ResourceDecoder}, and
     ...
     *
     * @see com.bumptech.xchat.load.resource.transcode.UnitTranscoder
     * @see com.bumptech.xchat.load.resource.transcode.GlideBitmapDrawableTranscoder
     * @see com.bumptech.xchat.load.resource.transcode.GifBitmapWrapperDrawableTranscoder
     *
     ...
     * impractical to return that size from {@link Target#getSize(com.bumptech.xchat.request.target.SizeReadyCallback)}.
     *
